...
2. Create the secret file:
   ```
   printf "YOUR_PORTIA_FLUXER_BOT_TOKEN_HERE" > ./secrets/portia_fluxer_token
   printf "YOUR_PRISM_FLUXER_BOT_TOKEN_HERE" > ./secrets/prism_fluxer_token
   printf "YOUR_PUCK_FLUXER_BOT_TOKEN_HERE" > ./secrets/puck_fluxer_token
   ```
...
After creating all six secret files, set permissions:
